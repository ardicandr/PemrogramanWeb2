        ...
        <table class="min-w-full leading-normal">
            <thead>
                <tr>
                    ...
                    <th class="px-5 py-3 border-b-2 bg-gray-100 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Sku</th>
                    ...
                    <th class="px-5 py-3 border-b-2 bg-gray-100 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Price</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="px-5 py-5 border-b bg-white text-sm">
                        <flux:dropdown>
                            <flux:button icon="chevron-down" trailing="actions">Actions</flux:button>
                            <flux:menu>
